// ==UserScript==
// @name         Krunker Java Plus 𝓧 HAX v2
// @namespace    https://github.com/Krunker-Java-plus-X
// @version      2.0
// @description  Krunker Java Plus 𝓧 HAX
// @author        Krunker Java Plus 𝓧 HAX v2
        ...
        if(me && renderer.scene) {
            ...
            if (topLeft && GUI) {
                if (!topLeft.contains(GUI)) {
                    ...
                    if (menuDirty) {
                        menuDirty = false;
                        GUI.innerHTML = "<br><h4 style='text-align:center;color:#1E90FF;'>Krunker Java Plus 𝓧 Hax v2 ✅</h4><hr>";
                        for (const feature of features) {
